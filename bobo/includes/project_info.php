<?php
  ...
  $PROJ_KEYWORDS = "java, lucene, faceted-search, bobo-browse";

  /* Favicon image file location and type */
  $PROJ_FAVICON_PATH = "images/bobo_small.jpg";
  $PROJ_FAVICON_MIME = "images/bobo_small.jpg";

  /* Project icon in header */
  $PROJ_ICON_PATH = "images/bobo_small.jpg";
  /* Navigation links in the sidebar */
  $PROJ_NAV_LINKS = array("downloads" => "http://github.com/javasoze/bobo/downloads",
  ...
  /* Project color */
  $PROJ_PRIMARY_COLOR = "#000033";

  /* Google analytics tracking code */
  $PROJ_GOOGLE_ANALYTICS = "UA-7818013-2";

  $PROJ_HTML = '<iframe src="http://www.facebook.com/plugins/likebox.php?id=147767748591111&amp;width=150&amp;connections=2&amp;stream=false&amp;header=false&amp;height=255" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:150px; height:255px;" allowTransparency="true"></iframe>';
