...
Code contributions are very welcome. There is a <a href="https://github.com/voldemort/voldemort/wiki/Fun-Projects">project idea wiki page</a> that has interesting (but sometimes non-trivial) projects if you want to see some ideas. Feel free to email the <a href="http://groups.google.com/group/project-voldemort">mailing list</a> if you want to discuss any idea you are considering or have questions about how to proceed. There is also an IRC channel at chat.us.freenode.net #voldemort.	
</p>
<p>
